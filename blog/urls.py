...
from blog.views import IndexView, PostDetailView, CategoryListView, TagListView, CategoryPostView, TagPostView,SearchPostView,CommentFormView,comment_approve,comment_remove, ReplyFormView,reply_approve,reply_remove
...
urlpatterns = [
    ...
    path('comment/<int:pk>/comment_remove/', comment_remove, name='comment_remove'),
